...
<div class="topmenu w-100 px-2">  
    <div class="swiper-container">  
        <div class="swiper-wrapper">
            <?php
            echo '<span class="swiper-slide"><a href="./" class="text-primary">Home page</a></span>';
...
<div class="container d-lg-none d-md-none p-0">
 ...
 ?>
  ...
  <div class="form-group" >
      <input type="text" name="v" style="width: 50%;height: 50px;border: none;box-sizing: border-box;padding: 14px 18px;" placeholder="Please enter video ID or YouTube link"  autocomplete="off" /><button type="submit"  style="width: 18%;border: none;height: 50px;background-color: #e62117;color: #fff;font-size: 18px;display: inline-block;" ><i class="fa fa-youtube-play fa-lg pr-1"></i>Play</button>
  </div>
    </form>
    <p class="text-white m-0">Please do not use this website for illegal purposes.</p>
    <p class="text-white m-0">Contribute if you like this site.</p>
    <p class="text-white m-0">And don't forget to share it with your friends.</p>
    <p class="text-white m-0">Enjoy.</p>
    </div>
    
    <div class="row pt-2 pb-2">
    <div class="col-8 sm-p">
      <span class="txt2 ricon h5">Trending</span>
    </div>
