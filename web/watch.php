    ...
    <div class="row">
        <div class="col-md-8 col-sm-12 col-xs-12 col-lg-8 leffix">
            ...
            <div class="vinfo fsize2 clearfix">
                ...
                <span class="pr-1">
                    <a href="./content.php?cont=video&v=<?php echo $videodata['items']['0']['id'] ?>" target="_blank" class="fsize2"><i class="fa fa-share-square-o pr-1"></i>Download</a>
                </span>
                </span>
             </div>
                ...
                <div id="accdiv" class="px-3 py-2 mt-2 fsize2 clearfix ">
                    ...
                    <a href="./channel.php?channelid=<?php echo $videodata['items']['0']['snippet']['channelId'] ?>" class="btn btn-sm btn-c pull-right fsize2 my-1"><p class="text-primary m-0 px-2">Home page</p></a>
