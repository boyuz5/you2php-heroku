...
case 'DMCA':
	...
	break;
case 'video':
    $headtitle='Video downloading tool'.'-'.SITE_NAME;
	break;
case 'api':
         ...
         <div class="col-md-9 relatedlist">
            ...
            switch ($cont) {
		        ...
		        echo '<div id="videocont"></div>
            		...
            		echo '<option '. $relevance .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&ptk='.$ptk.'">Most popular</option>';
            		echo '<option ' . $date1 .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&order=date&ptk='.$ptk.'">Latest release</option>';
            		echo '<option ' . $viewCount .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&order=viewCount&ptk='.$ptk.'">Most views</option>';
            		echo '</select></div></div>';
